...
void Game::setWindow(sf::RenderWindow* window,sf::View* gui_v,sf::View* map_v){
    mywindow = window;
    gui_view = gui_v;
        gui_view->reset(sf::FloatRect(360,200, 720, 480));
    map_view = map_v;
...
void Game::handleKeys(sf::Event e){
            ...
            if (e.type == sf::Event::MouseMoved ){//////escape!!//////
                if (sf::Mouse::isButtonPressed(sf::Mouse::Left)){  
                    sf::Vector2i position = sf::Mouse::getPosition();
                    sf::Vector2i position2(mywindow->mapPixelToCoords (position,*map_view)) ;                        a.mapa.changeTile(position2,&rm);
                    }
