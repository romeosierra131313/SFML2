...
Tile::Tile(int T_Type,sf::Vector3i loca,int Tile_Width,romeo::Resource* rm){
...
bool Tile::Am_I_Here(sf::Vector2i here){
         ...
         if(S.getGlobalBounds().contains(here.x,here.y)){
            ...
            std::cout<<here.x<<"mmmmmmmmmm" <<here.y<<std::endl;
...
void Tile::render(sf::RenderWindow* mywindow,float t){
 ...
 void Tile::renderHitbox(sf::RenderWindow* mywindow,float t){
